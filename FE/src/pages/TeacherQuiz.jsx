...
<div className="w-full h-16 px-6 flex items-center justify-between">
    ...
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <button
        type="button"
        className="h-10 md:h-11 px-5 md:px-6 rounded-xl bg-sky-500 text-white text-sm md:text-base font-semibold shadow-sm hover:bg-sky-600 active:bg-sky-700"
      >
        저장
      </button>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <div className="px-2 h-5 rounded-full bg-sky-500/10">
                <span className="text-[12px] font-semibold text-sky-500 leading-5">p. -</span>
              </div>
            </div>

            <div className="max-h-56 overflow-auto">
              <p className="text-sm leading-6 text-slate-700">
                선택된 텍스트가 없습니다. 교재에서 영역을 선택 후 &quot;퀴즈 만들기&quot;를 눌러보세요.
              </p>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-4 space-y-3">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  title="복제"
                >
                  <span className="block w-4 h-4 bg-slate-900 rounded-sm" />
                </button>
                <button
                  type="button"
                  className="h-9 w-9 rounded-full hover:bg-gray-100 grid place-items-center"
                  title="삭제"
                >
                  <span className="block w-4 h-4 bg-slate-900 rounded-full" />
                </button>
              </div>
            </div>
              ...
              <div className="space-y-2">
                {options.map((opt, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <input type="radio" className="size-4 rounded-full border border-gray-600" />
                    <input
                      value={opt}
                      onChange={(e) =>
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <div className="flex items-center gap-2 h-[42px]">
                ...
                <div className="relative w-[102px] h-[42px]">
                  <select
                    value={type}
              ...
              <div className="flex items-center gap-2 h-5">
                ...
                <input
                  ...
                  className="w-28"
                />
                <span className="w-6 text-center text-[14px] font-semibold text-slate-900">{difficulty}</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <aside className="w-[450px] flex flex-col">
          <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-3">
            ...
            <div className="pt-5 border-t border-gray-200 space-y-2">
              <button
                type="button"
                className="h-10 w-full rounded-xl bg-sky-500 text-white text-[16px] font-semibold"
              >
                퀴즈 발행
              </button>
              <button
                type="button"
                className="h-[42px] w-full rounded-xl border border-gray-200 text-[16px] font-semibold text-slate-900"
              >
                임시 저장
              </button>
              <button
